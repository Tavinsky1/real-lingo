...
class AdminInlineEditor {
    ...
    findEntryElements() {
        ...
        // Check URL for entry ID if no elements found
    ...
    addControlsToEntry(entryElement) {
        ...
        controls.innerHTML = `
            ...
            <button class="admin-edit-btn" onclick="adminEditor.editEntry(${entryId})">✏️ Edit</button>
            <button class="admin-edit-btn warning" onclick="adminEditor.flagEntry(${entryId})">⚠️ Flag</button>
            <button class="admin-edit-btn" onclick="adminEditor.addTranslation(${entryId})">🌐 Translation</button>
            <button class="admin-edit-btn" onclick="adminEditor.addExample(${entryId})">💬 Example</button>
            <button class="admin-edit-btn danger" onclick="adminEditor.deleteEntry(${entryId})">🗑️ Delete</button>
        `;
            ...
            <div class="admin-modal-content">
                ...
                <form id="edit-entry-form">
                    ...
                    <div class="admin-form-group">
                        ...
                        <input type="text" name="part_of_speech" value="${entry.part_of_speech || ''}">
                    </div>
                    <div class="admin-form-group">
                        <label>Notes:</label>
...
// Initialize the admin editor when DOM is ready
